...
The [provider-learn](https://github.com/garyleungsky/provider-learn) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-learn](https://github.com/crossplane-contrib/provider-jet-learn) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/garyleungsky/provider-learn/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/garyleungsky/provider-learn/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/garyleungsky/provider-learn/blob/main/hack/boilerplate.go.txt](https://github.com/garyleungsky/provider-learn/blob/main/hack/boilerplate.go.txt)
...
The [provider-learn](https://github.com/garyleungsky/provider-learn)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/garyleungsky/provider-learn/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/garyleungsky/provider-learn/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue learns (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/garyleungsky/provider-learn/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Learns: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/garyleungsky/provider-learn/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
