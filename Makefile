# ====================================================================================
# Setup Project
PROJECT_NAME := provider-learn
PROJECT_REPO := github.com/garyleungsky/$(PROJECT_NAME)
...
XPKGS = provider-learn
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-learn: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Learn CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Learn controllers
...
# This target prepares repo for your provider by replacing all "learn"
